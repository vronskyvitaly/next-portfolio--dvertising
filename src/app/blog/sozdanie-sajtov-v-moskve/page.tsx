...
const faq = [
  {
    q: 'Сколько стоит сайт под ключ в Москве?',
  ...
  {
    q: 'Можно ли заказать разработку сайта удалённо, если я не в Москве?',
    a: 'Да. Формально я работаю с клиентами в Москве и Санкт-Петербурге, но фактически веду проекты по всей России полностью удалённо: бриф, обсуждение макетов и приёмка работ проходят по видеосвязи и в Telegram, личное присутствие не требуется.'
  },
  {
        ...
        <div className='relative z-10 max-w-3xl mx-auto px-6 py-16 sm:py-24'>
          ...
          <header className='mb-12'>
            ...
            <p className='text-lg text-gray-400 leading-relaxed'>
              Разбираю, из чего складывается цена разработки сайта в Москве,
              сколько занимает каждый этап и как не переплатить подрядчику,
          ...
          <article className='space-y-14 text-gray-300 leading-relaxed'>
            ...
            <section>
              <h2 className='text-2xl font-bold text-white mb-4'>
                Разброс цен на сайт в Москве: от 15 000 до полумиллиона
              </h2>
              <p className='mb-4'>
                Наберите в поиске «заказать сайт в Москве», и первое, что
            ...
            <section>
              <h2 className='text-2xl font-bold text-white mb-4'>
                Сколько стоит сайт в Москве по типам: ориентиры на 2026 год
              </h2>
              <p className='mb-6'>
              ...
              <p className='mt-6'>
                Отдельно про Москву: рынок здесь конкурентнее, чем в среднем
                по стране, поэтому нижняя граница цен ниже, чем у крупных
                агентств, но выше, чем у фрилансеров без опыта в бизнес-задачах.
                Разумный ориентир - цена, за которой стоит понятный процесс, а
                не самая маленькая цифра в подборке.
              </p>
            </section>
            ...
            <section>
              <h2 className='text-2xl font-bold text-white mb-4'>
                Типичные ошибки при заказе сайта в Москве
              </h2>
            ...
            <section>
              ...
              <p className='mb-4'>
                ...
                для клиента из сферы услуг в Москве, время обработки заявки
            ...
            <section>
              <h2 className='text-2xl font-bold text-white mb-6'>
                Частые вопросы о заказе сайта в Москве
              </h2>
              <div className='space-y-4'>
                {faq.map(item => (
                  <div
          ...
          >
            ...
            <p className='text-gray-400 leading-relaxed text-sm'>
              Разброс цен на сайты в Москве большой, но не хаотичный - за ним
          ...
          >
            <h2 className='text-2xl font-bold text-white mb-3'>
              Готовы обсудить разработку сайта в Москве?
            </h2>
            <p className='text-gray-400 mb-8 max-w-md mx-auto'>
              Разрабатываю сайты под ключ на Next.js: от лендинга до
              интернет-магазина с интеграцией CRM и онлайн-оплатой. Первая
              оценка стоимости и сроков - бесплатно.
            </p>
